...
// DI tokens (MATCH_REPOSITORY / ODDS_REPOSITORY) so use-cases depend on the PORT, not
// the Prisma adapter.
import { Global, Module } from '@nestjs/common';
import { MATCH_REPOSITORY, ODDS_REPOSITORY } from '@betvision/domain';
...
@Module({
  ...
  exports: [PrismaService, MATCH_REPOSITORY, ODDS_REPOSITORY],
})
